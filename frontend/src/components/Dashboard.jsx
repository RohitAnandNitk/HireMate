        ...
        <div className="flex-1 flex flex-col">
            <header className="sticky top-0 z-10 bg-white/90 backdrop-blur border-b border-gray-200">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <button disabled={!files.length} className={`px-3 py-2 text-sm rounded-md ${files.length ? 'bg-gray-900 text-white hover:bg-black' : 'bg-gray-200 text-gray-500 cursor-not-allowed'}`}>Process Resumes</button>
                </div>
            </header>
