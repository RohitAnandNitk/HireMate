const PRESET_SKILLS = [
    ...
    'jQuery', 'Redux', 'MobX', 'Zustand', 'Webpack', 'Vite', 'Parcel',
    ...
    'Rust', 'Actix', 'C++', 'Kotlin', 'Scala', 'Clojure',
    
    // Mobile Development
    'React Native', 'Flutter', 'Swift', 'Objective-C', 'Kotlin', 'Java Android',
    ...
    'Neo4j', 'Firebase', 'Supabase', 'PlanetScale', 'Prisma',
    
    // Cloud & DevOps
    'AWS', 'Azure', 'Google Cloud', 'Docker', 'Kubernetes', 'Jenkins',
    'GitLab CI', 'GitHub Actions', 'CircleCI', 'Terraform', 'Ansible',
    'Vagrant', 'Chef', 'Puppet', 'Nginx', 'Apache', 'Linux', 'Ubuntu',
    
    // Data Science & AI/ML
    'Python', 'R', 'Pandas', 'NumPy', 'Scikit-learn', 'TensorFlow',
    'PyTorch', 'Keras', 'OpenCV', 'NLTK', 'SpaCy', 'Jupyter',
    'Matplotlib', 'Seaborn', 'Plotly', 'Apache Spark', 'Hadoop',
    'Machine Learning', 'Deep Learning', 'Computer Vision', 'NLP',
    
    // Testing
    'Jest', 'Cypress', 'Selenium', 'Playwright', 'Puppeteer', 'TestNG',
    'JUnit', 'Mocha', 'Chai', 'Enzyme', 'React Testing Library',
    'Postman', 'Insomnia', 'K6', 'Artillery',
